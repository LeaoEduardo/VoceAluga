...
public class TelaClienteController {
	...
	void initialize() {
		...
		// CPF/Passaporte inserido na pesquisa efetuada anteriormente na tela gerar
		// locacao
		String cpf = Contexto.getInstancia().getCliente().getCpf();
		String passaporte = Contexto.getInstancia().getCliente().getPassaporte();

		// Abaixo os dados do cliente devem ser carregados do BD, a partir do
		// CPF/Passaporte acima
